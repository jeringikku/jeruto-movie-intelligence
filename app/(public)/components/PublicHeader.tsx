...
export default function PublicHeader() {
  ...
  useEffect(() => {
    ...
    async function loadUser() {
      ...
      if (error) {
        console.error(
          "Public header session check failed:",
          error
        );
                ...
                {!authLoading && user && (
                  <nav className="mt-2 space-y-1">
                    ...
                    <Link
                      ...
                      className="group flex items-center justify-between rounded-lg border border-violet-400/10 bg-violet-400/[0.03] px-3 py-3 text-[11px] font-medium text-zinc-300 transition hover:border-violet-400/20 hover:bg-violet-400/[0.06] hover:text-violet-300"
                    >
                      <span>
                        My Account
                      </span>
                    ...
                    <button
                      ...
                      className="group flex w-full items-center justify-between rounded-lg border border-transparent px-3 py-3 text-left text-[11px] font-medium text-zinc-500 transition hover:border-zinc-800 hover:bg-black hover:text-red-300"
                    >
                      <span>
                        Sign Out
                      </span>

                      <span className="text-zinc-700 transition group-hover:translate-x-0.5 group-hover:text-red-400">
                        →
                      </span>
                    </button>
