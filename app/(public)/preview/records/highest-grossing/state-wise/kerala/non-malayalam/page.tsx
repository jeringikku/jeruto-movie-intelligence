...
export default async function KeralaNonMalayalamPage({
  searchParams,
}: Props) {
...
if (moviesError) {
  console.error(
    "Kerala non-Malayalam movie query error:",
    moviesError
  );
}
 ...
 * is_primary = true.
 *
 * We do NOT care whether Malayalam is also present
...
/*
 * =========================================================
 * 5. FILTER NON-MALAYALAM MOVIES
 * =========================================================
 *
 * ONLY the PRIMARY language is checked.
 *
 * Malayalam as a secondary/dubbed language
...
const eligibleMovies =
  ...
  /*
   * =========================================================
   * 6. GROUP KERALA COLLECTION BY MOVIE
   * =========================================================
   */
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <section className="mt-8 rounded-xl border border-zinc-900 bg-zinc-950/40 p-5">
          ...
          <p className="mt-2 text-[9px] leading-5 text-zinc-500">
            ...
            Malayalam. Language classification
            ...
            Kerala theatrical collection is
            available.
          </p>
