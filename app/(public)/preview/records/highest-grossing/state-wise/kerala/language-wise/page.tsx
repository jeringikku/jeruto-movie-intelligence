...
const languages = [
  {
    name: "Malayalam",
    slug: "malayalam",
    description: "Highest grossing Malayalam movies in Kerala",
  },
  {
    name: "Tamil",
    slug: "tamil",
    description: "Highest grossing Tamil movies in Kerala",
  },
  {
    name: "Telugu",
    slug: "telugu",
    description: "Highest grossing Telugu movies in Kerala",
  },
  {
    name: "Hindi",
    slug: "hindi",
    description: "Highest grossing Hindi movies in Kerala",
  },
  {
    name: "Kannada",
    slug: "kannada",
    description: "Highest grossing Kannada movies in Kerala",
  },
  {
    name: "English",
    slug: "english",
    description: "Highest grossing English / Hollywood movies in Kerala",
  },
];

export default function KeralaLanguageWisePage() {
  return (
    <div className="min-h-screen bg-black text-zinc-300">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="mb-6">
          ...
          >
            <span>←</span>
            <span>Back to Kerala Records</span>
          </Link>
        </div>
        ...
        <section className="border-b border-zinc-900 pb-7">
          ...
          <p className="mt-3 max-w-xl text-[10px] leading-5 text-zinc-400">
            Explore Kerala's highest-grossing movies
        ...
        <section className="mt-7">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            ...
            {languages.map((language) => (
              <Link
                key={language.slug}
                href={`/preview/records/highest-grossing/state-wise/kerala/language-wise/${language.slug}`}
