...
async function fetchStateBoxOfficeInChunks(
  ...
  for (let i = 0; i < movieIds.length; i += chunkSize) {
    ...
    if (error) {
      console.error(
        "Kerala Malayalam box-office query error:",
        error
      );
      continue;
    }
...
export default async function KeralaKannadaPage({
  searchParams,
}: Props) {
  ...
  if (moviesError) {
    console.error(
      "Kerala Malayalam movie query error:",
      moviesError
    );
  }
  ...
  /*
   * =========================================================
   * 5. FILTER PRIMARY MALAYALAM MOVIES
   * =========================================================
   *
   * ONLY movies whose PRIMARY language is Malayalam
   * are included.
   */
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-300">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="mb-6">
          <Link
            href="/preview/records/highest-grossing/state-wise/kerala/language-wise"
        ...
        <div className="mt-7 flex justify-between border-t border-zinc-900 pt-5">
          ...
          <Link
            href="/preview/records/highest-grossing/state-wise/kerala/language-wise"
            className="text-[9px] text-violet-500 transition hover:text-zinc-300"
          >
            ← Language-wise
          </Link>

          <Link
            href="/preview/records/highest-grossing/state-wise/kerala/language-wise/english"
            className="text-[9px] text-violet-500 transition hover:text-zinc-300"
          >
            English →
          </Link>
      ...
      <footer className="border-t border-zinc-900 px-4 py-6 sm:px-6">
        ...
        <div className="mx-auto max-w-5xl text-[8px] text-zinc-700">
          Jeruto Movie Intelligence · Kerala Language Records
        </div>
