...
const languages = [
    ...
    name: "Tamil",
    slug: "tamil",
    description: "Highest grossing Tamil movies in Tamilnadu",
  },
  {
    name: "Malayalam",
    slug: "malayalam",
    description: "Highest grossing Malayalam movies in Tamilnadu",
  },
  
  {
    name: "Telugu",
    slug: "telugu",
    description: "Highest grossing Telugu movies in Tamilnadu",
  },
  {
    name: "Hindi",
    slug: "hindi",
    description: "Highest grossing Hindi movies in Tamilnadu",
  },
  {
    name: "Kannada",
    slug: "kannada",
    description: "Highest grossing Kannada movies in Tamilnadu",
  },
  {
    name: "English",
    slug: "english",
    description: "Highest grossing English / Hollywood movies in Tamilnadu",
  },
];

export default function TamilNaduLanguageWisePage() {
  return (
    <div className="min-h-screen bg-black text-zinc-300">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="mb-6">
          ...
          >
            <span>←</span>
            <span>Back to Tamilnadu Records</span>
          </Link>
        </div>
        ...
        <section className="border-b border-zinc-900 pb-7">
          ...
          <p className="mt-3 max-w-xl text-[10px] leading-5 text-zinc-400">
            Explore Tamilnadu's highest-grossing movies
        ...
        <section className="mt-7">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            ...
            {languages.map((language) => (
              <Link
                key={language.slug}
                href={`/preview/records/highest-grossing/state-wise/tamil-nadu/language-wise/${language.slug}`}
      ...
      <footer className="border-t border-zinc-900 px-4 py-6 sm:px-6">
        ...
        <div className="mx-auto max-w-5xl text-[8px] text-zinc-700">
          Jeruto Movie Intelligence · Tamilnadu Language Records
        </div>
