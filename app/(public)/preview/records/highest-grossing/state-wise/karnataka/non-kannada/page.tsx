...
async function fetchStateBoxOfficeInChunks(
  ...
  for (
    ...
    if (error) {
      console.error(
        "Karnataka box-office query error:",
        error
      );
...
export default async function KarnatakaNonKannadaPage({
  searchParams,
}: Props) {
...
if (moviesError) {
  console.error(
    "Karnataka non-Kannada movie query error:",
    moviesError
  );
}
 ...
 * is_primary = true.
 *
 * We do NOT care whether Kannada is also present
...
/*
 * =========================================================
 * 5. FILTER NON-KANNADA MOVIES
 * =========================================================
 *
 * ONLY the PRIMARY language is checked.
 *
 * Kannada as a secondary/dubbed language
...
const eligibleMovies =
  ...
  /*
   * =========================================================
   * 6. GROUP KARNATAKA COLLECTION BY MOVIE
   * =========================================================
   */
    ...
    <div className="min-h-screen bg-black text-zinc-300">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <section className="mt-8 rounded-xl border border-zinc-900 bg-zinc-950/40 p-5">
          ...
          <p className="mt-2 text-[9px] leading-5 text-zinc-500">
            ...
            Kannada. Language classification
            ...
            Kannada theatrical collection is
            available.
          </p>
      ...
      <footer className="border-t border-zinc-900 px-4 py-6 sm:px-6">
        ...
        <div className="mx-auto max-w-5xl text-[8px] text-zinc-700">
          Jeruto Movie Intelligence · Karnataka Records
        </div>
