...
export default async function TeluguStatesAllMoviesPage({
  searchParams,
}: Props) {
   ...
   *
   * This intentionally includes movies from every
   * language and industry because this is a domestic
   * Telugu States ranking.
   */
    ...
    <div className="min-h-screen bg-black text-zinc-300">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="mt-7 flex justify-between border-t border-zinc-900 pt-5">
          ...
          <Link
            href="/preview/records/highest-grossing/state-wise/telugu-states/non-telugu"
            className="text-[9px] text-violet-400 transition hover:text-zinc-300"
          >
            Non-Telugu →
          </Link>
