...
async function fetchStateBoxOfficeInChunks(
  ...
  for (let i = 0; i < movieIds.length; i += chunkSize) {
    ...
    if (error) {
      console.error(
        "Telugu States English box-office query error:",
        error
      );
      continue;
    }
...
export default async function TeluguStatesEnglishPage({
  searchParams,
}: Props) {
        ...
        <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
          <div className="rounded-xl border border-zinc-900 bg-zinc-950/40 p-6">
            <p className="text-[10px] text-red-400">
              Telugu States market data could not be loaded.
            </p>
          </div>
        </main>
      </div>
  ...
  if (moviesError) {
    console.error(
      "Telugu States English movie query error:",
      moviesError
    );
  }
  ...
  /*
   * =========================================================
   * 5. FILTER PRIMARY ENGLISH MOVIES
   * =========================================================
   *
   * ONLY movies whose PRIMARY language is English
   * are included.
   *
   * For JMI language-wise records, English represents
   * English-language / Hollywood movies.
   */
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-300">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="mb-6">
          <Link
            href="/preview/records/highest-grossing/state-wise/telugu-states/language-wise"
        ...
        <section className="mt-8 rounded-xl border border-zinc-900 bg-zinc-950/40 p-5">
          ...
          <p className="mt-2 text-[9px] leading-5 text-zinc-500">
            ...
            For JMI language-wise records, this
            category represents English-language
            and Hollywood movies. Secondary or
            dubbed languages do not affect the
            classification. Rankings are based
            on current JMI theatrical collection
            across Andhra Pradesh and Telangana,
            combined as the Telugu States market.
          </p>
      ...
      <footer className="border-t border-zinc-900 px-4 py-6 sm:px-6">
        ...
        <div className="mx-auto max-w-5xl text-[8px] text-zinc-700">
          Jeruto Movie Intelligence · Telugu States Language Records
        </div>
