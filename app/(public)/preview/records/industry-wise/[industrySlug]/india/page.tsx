...
async function fetchStateBoxOfficeInChunks(
  ...
  for (let i = 0; i < movieIds.length; i += chunkSize) {
    ...
    if (error) {
      console.error(
        "Industry India box-office query error:",
        error
      );
      continue;
    }
...
export default async function IndustryIndiaPage({
  params,
  searchParams,
}: Props) {
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <section className="border-b border-zinc-900 pb-7">
          ...
          <div className="text-[9px] font-medium tracking-[0.28em] text-green-400">
            {industry.name.toUpperCase()} · INDIA
          </div>
          ...
          <p className="mt-3 max-w-xl text-[10px] leading-5 text-zinc-500">
            ...
            theatrical collection across India.
          </p>
        ...
        <section className="mt-8 rounded-xl border border-zinc-900 bg-zinc-950/40 p-5">
          ...
          <p className="mt-2 text-[9px] leading-5 text-zinc-500">
            ...
            movie-industry database. India
            collection is calculated from the
            combined current JMI theatrical gross
            recorded across Indian states. Overseas
            collection is not included in this
            ranking.
          </p>
