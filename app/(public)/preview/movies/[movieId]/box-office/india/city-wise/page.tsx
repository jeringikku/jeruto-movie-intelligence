...
export default async function CityWiseBoxOfficePage({
  params,
}: {
  ...
  if (cityError) {
    console.error(
      "JMI City-wise Box Office Error:",
      cityError
    );
  }

  const records: CityRecord[] =
    (cityData as CityRecord[] | null) ?? [];
   ...
   * IMPORTANT:
   *
   * City figures are parallel geographic breakdowns.
   * They must NOT be presented as the movie's
   * overall India Gross.
   *
   * grossBase is used only as the denominator
   * for city distribution percentages.
   */
          ...
          <div className="mx-auto max-w-6xl px-5 py-10 sm:px-6 sm:py-14 lg:px-8">
            ...
            <div className="mt-8">
              ...
              <div className="mb-4">
                ...
                <p className="mt-1 text-[9px] text-zinc-600">
                  Latest cumulative figures by city.
                </p>
