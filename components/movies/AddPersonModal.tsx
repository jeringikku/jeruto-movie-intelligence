...
async function loadCreditTypes() {
  ...
  console.log("Credit Types Error:", error);
...
.insert({
  ...
  value={selectedPerson ? Number(selectedPerson) : null}
  onChange={(id) => setSelectedPerson(String(id))}
...
>
  ...
  <p className="mt-1 text-xs text-zinc-500">
    Defines the type or importance of the person's participation in this film.
  </p>
</div>
